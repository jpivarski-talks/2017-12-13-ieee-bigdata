...
\begin{frame}{Offset array $\to$ start, stop arrays \only<3->{for filtering}}
\vspace{0.5 cm}
...
\begin{frame}{Offset array $\to$ start, stop arrays for sorting}
\vspace{0.5 cm}
